...
const messages = [
    {
        ...
        image: "https://honkai-star-rail.fandom.com/wiki/File:Sticker_PPG_01_March_7th_13.jpg"
    },
    {
    ...
    {
        text: "nanya terakhir, kalo \"no\" aku nyerah :(",
...
yesBtn.addEventListener('click', () => {
    title.innerHTML = "YAYYY AKU JUGA KANGEN KAMUUU T__T";
